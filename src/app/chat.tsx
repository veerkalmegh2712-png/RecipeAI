...
export default function ChatScreen() {
    ...
    const sendMessage = async () => {
        ...
        try {
            console.log("=================================");
            console.log("CALLING DJANGO API...");
            console.log("USER MESSAGE:", userMessage);
            console.log("=================================");

            const response = await fetch(
                "http://10.81.143.55:8000/api/recipe/",
                {
                    method: "POST",
                    headers: {
            ...
            if (!data.recipe) {
                throw new Error(
                    "No recipe returned from Django."
                );
            }
            ...
            const recipe: Recipe = {
                ...
                description:
                    ...
                    "A delicious recipe generated by RecipeAI.",
